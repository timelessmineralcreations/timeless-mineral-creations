...
import EasyPostShippingPanel from "@/components/admin/EasyPostShippingPanel";
    ...
    >
                    ...
                    <DetailRow
                      ...
                      value={(() => {
                        ...
                        const value =
                          ...
                          configuration?.selectedChannelWidth ??
                    ...
                    <DetailRow
                      ...
                      value={displayValue(
                          configuration?.design?.name ||
                            ...
                            configuration?.selectedDesign?.name ||
                            configuration?.selectedDesign?.label ||
                            configuration?.designName ||
                            configuration?.inlayStyle?.name ||
                            item.design
                        )}
                    />
      ...
      >
        ...
        <ProductionWorkspace
          ...
          initialValues={{
            coreConfirmedAt:
              order.coreConfirmedAt
                ? order.coreConfirmedAt.toISOString()
                : null,

            sizeConfirmedAt:
              order.sizeConfirmedAt
        ...
        <IncomingPackagePanel
          ...
          initialCarrier={
            order.incomingCarrier ||
            ""
          }
          initialTrackingNumber={
            order.incomingTrackingNumber ||
            ""
          }
          initialTrackingStatus={
            order.incomingTrackingStatus ||
            ""
          }
          materialsReceivedAt={
        ...
        <OrderTimeline
          order={{
            ...
            materialsVerifiedAt:
              order.materialsVerifiedAt?.toISOString() ||
              null,
            ...
            outgoingDeliveredAt:
              order.outgoingDeliveredAt?.toISOString() ||
              null,
          }}
        />
        ...
        >
          ...
          {order.shippingEmailSentAt ? (
            ...
            >
              Not sent yet. It will send automatically when a real EasyPost shipping label is purchased.
            </div>
          ) : (
            <div
              style={{
            ...
            >
              Cannot send because this order does not have a customer email address.
            </div>
          )}
        </div>

        <EasyPostShippingPanel
          orderId={
            order.id
          }
          initialCarrier={
            order.outgoingCarrier ||
            ""
          }
          initialTrackingNumber={
          ...
          initialTrackingStatus={
            order.outgoingTrackingStatus ||
            ""
          }
          initialLabelUrl={
            order.outgoingLabelUrl ||
            ""
          }
          initialShippedAt={
