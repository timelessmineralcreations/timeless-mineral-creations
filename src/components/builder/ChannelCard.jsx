...
export default function ChannelCard({
  ...
  const glowEnabled =
    channel?.glow?.enabled === true;

  const selectionMode =
    channel?.selectionMode || "either";

  const requiresBoth =
    selectionMode === "both";

  const allowsBoth =
    memorialEnabled && mineralsEnabled;
  ...
  const hasMaterialSelection =
    Boolean(selection.memorial) ||
    Boolean(selection.mineral);

  const memorialDescription =
  ...
  return (
    ...
    >
      ...
      {requiresBoth && (
        ...
        >
          This design uses both a
          memorial material and one
          natural mineral in this{" "}
          {groupLabel.toLowerCase()}
          .
        </div>
      )}
