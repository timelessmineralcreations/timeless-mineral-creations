    ...
    >
      ...
      >
        <div>
          ...
          >
            Manage the ways hair or fur can be
            positioned inside your memorial jewelry.
          </p>
        </div>
      ...
      {options.length === 0 ? (
        ...
        >
          ...
          >
            You already use Crescent Hair and
            Scattered Hair in Remi. Import those
            existing options into the new database
            catalog.
          </p>

          <form
            action={importExistingHairPlacements}
          >
            <button
              type="submit"
              style={{
